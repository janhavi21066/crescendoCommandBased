...
public class DrivetrainSubsystem extends SubsystemBase {
  /** Creates a new ExampleSubsystem. */
    ...
    public DifferentialDriveKinematics kinematics = new DifferentialDriveKinematics(OperatorConstants.trackWidthInMeters);
    public static double distanceCovered = 0;
    ...
    static double LeftDistance = -(left1.getSelectedSensorPosition() * OperatorConstants.rotationsToFeet);
    static double RightDistance = right1.getSelectedSensorPosition() * OperatorConstants.rotationsToFeet;
    ...
    private PathPlannerPath firstPath = PathPlannerPath.fromPathFile("note1amp");
    private Pose2d autoStartingPosition = firstPath.getStartingDifferentialPose();
    //public PathPlannerTrajectory traj = new PathPlannerTrajectory(null, chassisSpeeds, null);
    private Sendable robotOdometry = new Sendable() {
...
public void drivetrain() {
  ...
  public void periodic() {
    ...
    LeftDistance = -(left1.getSelectedSensorPosition() * OperatorConstants.rotationsToFeet);
    RightDistance = right1.getSelectedSensorPosition() * OperatorConstants.rotationsToFeet;
    ...
    SmartDashboard.putData("Field", m_field);
    SmartDashboard.putData("odometry", robotOdometry);
  }
    ...
    public DifferentialDriveWheelSpeeds getWheelSpeeds(){
      DifferentialDriveKinematics kinematics = new DifferentialDriveKinematics(OperatorConstants.trackWidthInMeters);
  ...
  public void setAutoStartingPose(){
    odometry.resetPosition(autoStartingPosition.getRotation(), 0, 0, autoStartingPosition);
  }
